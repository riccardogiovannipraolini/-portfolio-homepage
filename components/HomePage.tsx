...
const App = () => {
  ...
  const philosopherDeepDives = [
    { title: "Product Strategy Framework", desc: "Un modello replicabile per definire vision, mission e roadmap strategica.", icon: <Compass size={16}/> },
    { title: "Go-to-Market Planning", desc: "Piano di lancio completo: positioning, canali, pricing e metriche di successo.", icon: <PieChart size={16}/> },
    { title: "UX/UI Design System", desc: "Documentazione di design system e libreria componenti per scalare l'interfaccia.", icon: <Palette size={16}/> }
  ];

  const builderDeepDives = [
    { title: "SQL for Product Analytics", desc: "Query complesse per cohort analysis e retention tracking.", icon: <Database size={16} className="text-green-400"/>, lang: "SQL" },
    { title: "Python Data Pipelines", desc: "Automazione ETL per pulizia dati e reportistica automatizzata.", icon: <Terminal size={16} className="text-green-400"/>, lang: "PY" },
    { title: "A/B Testing Framework", desc: "Setup sperimentale rigoroso: ipotesi, sample size e significatività statistica.", icon: <TestTube size={16} className="text-green-400"/>, lang: "EXP" }
  ];
    ...
    <div className="min-h-screen flex flex-col font-sans bg-stone-100 text-neutral-900 selection:bg-orange-500 selection:text-white overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 h-14 flex shadow-lg bg-white border-b border-neutral-200">
        ...
        <div className="w-1/2 h-full flex items-center justify-end px-4 md:px-12 relative">
           ...
           <button className="md:hidden text-green-600 ml-auto" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 pointer-events-none">
          ...
          <span className="font-mono font-black text-orange-600 text-base md:text-xl tracking-widest whitespace-nowrap">
            RICCARDO PRAOLINI
          </span>
        </div>
      ...
      <div className="fixed top-14 left-0 w-full z-40 pointer-events-none">
        <div className="flex justify-center">
          <div className="bg-orange-600 text-white px-4 py-1 md:px-6 md:py-1.5 font-mono font-bold text-[10px] md:text-xs tracking-widest shadow-xl rounded-b-lg flex items-center gap-2">
        ...
        <div className="w-full md:w-1/2 bg-[#F2F0E9] relative flex flex-col pt-32 px-8 md:px-16 pb-16 border-r border-neutral-900">
          ...
          <div className="relative z-10">
              <div className="flex items-center gap-2 text-neutral-500 font-mono text-xs font-bold uppercase tracking-widest mb-6">
                <Compass size={14} className="text-orange-600"/> Product Mindset // Strategy
              </div>
              ...
              <h1 className="text-7xl md:text-9xl font-serif font-medium leading-[0.9] text-neutral-900 mb-8">
                The <span className="italic text-orange-600">Strategy</span><br/>of Why.
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-8 md:p-10 border border-neutral-800 bg-neutral-900/50">
                 <div className="flex items-center justify-between mb-6">
                   ...
                   <span className="text-xs font-mono text-neutral-500 uppercase tracking-widest">EXECUTION MASTERY</span>
                 </div>
                 <h3 className="text-2xl font-serif font-bold text-white mb-4">Delivery Affidabile</h3>
                 <p className="text-base text-neutral-500 leading-relaxed">Trasformo roadmap ambigue in ticket Jira pronti per il dev, riducendo i colli di bottiglia del 30%.</p>
              </div>
              ...
              <div className="p-8 md:p-10 border border-neutral-800 bg-neutral-900/50">
                 <div className="flex items-center justify-between mb-6">
                   ...
                   <span className="text-xs font-mono text-neutral-500 uppercase tracking-widest">PRODUCT MINDSET</span>
                 </div>
                 <h3 className="text-2xl font-serif font-bold text-white mb-4">Decisioni Data-Driven</h3>
                 <p className="text-base text-neutral-500 leading-relaxed">Non mi baso su opinioni. Uso SQL e Analytics per validare ogni ipotesi prima dello sviluppo.</p>
              </div>
              ...
              <div className="p-8 md:p-10 border border-neutral-800 bg-neutral-900/50">
                 <div className="flex items-center justify-between mb-6">
                   ...
                   <span className="text-xs font-mono text-neutral-500 uppercase tracking-widest">RARE COMBINATION</span>
                 </div>
                 <h3 className="text-2xl font-serif font-bold text-white mb-4">Humanities + Tech</h3>
                 <p className="text-base text-neutral-500 leading-relaxed">Filosofia + alfabetizzazione tecnica: first-principles thinking applicato con AI literacy e SQL funzionale.</p>
              </div>
      ...
      <div className="flex flex-col w-full relative bg-neutral-900" id="projects">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full min-h-screen border-b border-neutral-900">
          <div className="bg-[#F2F0E9] p-8 md:p-16 border-r border-neutral-300 relative flex flex-col justify-center">
             <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/paper.png')] opacity-50 pointer-events-none"></div>
             <div className="relative z-10">
                <span className="font-mono text-[10px] text-neutral-500 uppercase tracking-widest block mb-4">Case Study 01</span>
                ...
                <div className="bg-white p-8 shadow-xl border-l-4 border-green-600 max-w-md mb-10">
                  <h4 className="font-mono text-xs font-bold uppercase tracking-widest text-neutral-400 mb-2">Key Metrics</h4>
                  <div className="flex flex-col gap-1">
                    <div className="text-3xl font-bold text-neutral-900">MVP Readiness: 95%</div>
                    <div className="text-sm text-neutral-500 font-bold">GTM Launch: T-1 Sprint</div>
                  </div>
                </div>
                <button className="group flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-neutral-900 border-b-2 border-neutral-900 hover:text-green-700 hover:border-green-700 transition-colors pb-1 w-fit">
             ...
             <div className="relative z-10 w-full max-w-lg mx-auto">
                ...
                <div className="bg-[#0f1110] border border-green-500/20 p-8 relative shadow-2xl">
                   <div className="font-mono text-xs text-green-400 leading-relaxed">
                      <p className="mb-6 text-neutral-500 border-b border-green-900/30 pb-2 block w-full">// EXECUTION_METRICS.log</p>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="opacity-70">SPRINT_VELOCITY:</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full min-h-screen border-b border-neutral-900">
          <div className="bg-[#F2F0E9] p-8 md:p-16 border-r border-neutral-300 relative flex flex-col justify-center">
             <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/paper.png')] opacity-50 pointer-events-none"></div>
             <div className="relative z-10">
                <span className="font-mono text-[10px] text-neutral-500 uppercase tracking-widest block mb-4">Case Study 02</span>
                <h3 className="text-4xl font-serif font-bold text-neutral-900 mb-6">Modulo Digital Wellness</h3>
                <div className="flex items-center gap-3 mb-8">
                  <span className="font-mono text-xs font-bold bg-blue-100 text-blue-600 px-3 py-1 rounded-full border border-blue-200">PRODUCT DISCOVERY</span>
                </div>
                <p className="font-serif text-lg text-neutral-800 leading-relaxed mb-8">
          ...
          <div className="bg-[#0a0a0a] p-8 md:p-16 relative border-l border-neutral-800 flex flex-col justify-center">
             ...
             <div className="relative z-10 w-full max-w-lg mx-auto">
                ...
                <div className="bg-[#050505] border border-green-500/30 p-8 font-mono text-xs leading-relaxed text-green-400 shadow-2xl aspect-video flex flex-col justify-center">
                  <div className="mb-6 text-neutral-500 border-b border-green-900/30 pb-2 block w-full">// DISCOVERY_VALIDATION.log</div>
                  <div className="space-y-3">
                    ...
                    <div className="mt-2">
                      ...
                      <ul className="pl-4 text-neutral-400 space-y-1">
                        <li>→ Freelancers <span className="opacity-50">(high_variability)</span></li>
                        <li>→ Students <span className="opacity-50">(deadline_driven)</span></li>
                        <li>→ Remote_workers <span className="opacity-50">(async_chaos)</span></li>
                      </ul>
                    </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full min-h-screen border-b border-neutral-900">
          <div className="bg-[#F2F0E9] p-8 md:p-16 border-r border-neutral-300 relative flex flex-col justify-center">
             <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/paper.png')] opacity-50 pointer-events-none"></div>
             <div className="relative z-10">
                <span className="font-mono text-[10px] text-neutral-500 uppercase tracking-widest block mb-4">Case Study 03</span>
          ...
          <div className="bg-[#0a0a0a] p-8 md:p-16 relative border-l border-neutral-800 flex flex-col justify-center">
             ...
             <div className="relative z-10 w-full max-w-lg mx-auto">
                ...
                <div className="bg-[#050505] border border-green-500/30 p-8 font-mono text-xs leading-relaxed text-green-400 shadow-2xl aspect-video flex flex-col justify-center">
                  <div className="mb-6 text-neutral-500 border-b border-green-900/30 pb-2 block w-full">// PRODUCT_STRATEGY.yaml</div>
                  <div className="space-y-4">
                    <div>
                      ...
                      <ul className="pl-4 text-white space-y-1">
                        ...
                        <li>→ Consulenza <span className="opacity-50">(30% effort)</span></li>
                        <li>→ Scale-up <span className="opacity-30">(15% effort)</span></li>
                      </ul>
                    </div>
      ...
      <section className="py-32 bg-stone-100 border-t border-b border-neutral-300 text-center relative z-20 flex flex-col justify-center items-center min-h-screen">
         ...
         <h2 className="font-mono text-xl md:text-2xl tracking-[0.4em] text-neutral-500 mb-6">/// COMPLEMENTARY_TRACKS</h2>
             ...
             <div className="flex-1 flex flex-col justify-between gap-8">
               {philosopherDeepDives.map((item, idx) => (
                 <div key={idx} className="group cursor-pointer border-b border-neutral-300 pb-6 hover:pl-4 transition-all duration-300">
                   ...
                   <p className="text-base text-neutral-500 font-serif leading-relaxed">
                     {item.desc}
                   </p>
               ...
               {builderDeepDives.map((item, idx) => (
                 <div key={idx} className="group cursor-pointer bg-neutral-900/50 border border-green-900/30 p-6 hover:border-green-500 transition-all duration-300">
                   <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-xs font-mono text-neutral-600 bg-neutral-800 px-2 py-1 rounded">{item.lang}</span>
                   </div>
      ...
      <section className="py-32 bg-stone-100 border-t border-b border-neutral-300 text-center relative z-20 flex flex-col justify-center items-center min-h-screen">
         ...
         <h2 className="font-mono text-xl md:text-2xl tracking-[0.4em] text-neutral-500 mb-6">/// WHO I AM</h2>
         <p className="font-serif text-3xl md:text-4xl max-w-2xl mx-auto leading-tight text-neutral-800">
        ...
        <div className="max-w-4xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-8">
              <div>
                <span className="font-mono text-orange-600 text-xs font-bold uppercase tracking-widest mb-4 block">WHO I AM</span>
                <h2 className="font-serif text-4xl font-bold mb-6">More than a PM.<br/>A Builder-Philosopher.</h2>
                <p className="text-neutral-600 leading-relaxed mb-6 text-lg">
                  Studio Filosofia e Contemporary Humanities (Scuola Holden), ma costruisco prodotti. Coordino team da 18 mesi, gestisco sprint, analizzo dati con SQL. La mia rare combination: first-principles thinking applicato all'execution.
                </p>
                <p className="text-neutral-600 leading-relaxed mb-0 text-lg">
                  Cerco il mio primo ruolo da Junior PM dove posso dimostrare execution affidabile oggi e crescere verso discovery ownership domani.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-8 mt-2">
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="/cv.pdf" className="flex items-center gap-2 px-6 py-3 border-2 border-orange-600 text-orange-600 rounded font-bold text-sm hover:bg-orange-50 transition-colors">
                    DOWNLOAD CV <Download size={16}/>
                  </a>
                  <a href="#contact" className="flex items-center gap-2 px-6 py-3 bg-orange-600 text-white rounded font-bold text-sm hover:bg-orange-700 transition-colors shadow-lg">
      ...
      {/* === 8. FOOTER === */}
      <footer className="bg-neutral-950 text-white py-24 border-t border-neutral-800 min-h-[60vh] flex flex-col justify-center" id="contact">
        <div className="max-w-5xl mx-auto px-8 w-full">
           
           {/* Header Footer */}
           <div className="mb-16">
             <div className="font-mono text-green-500 text-sm uppercase tracking-widest mb-4">/// LET'S CONNECT</div>
             <h2 className="font-serif text-6xl font-bold mb-6">Let's Talk.</h2>
             <p className="text-neutral-400 text-xl max-w-xl">
               Hai un ruolo da Junior PM o vuoi discutere un progetto? Scrivimi o prenota un caffè.
             </p>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-neutral-800 pt-12">
             ...
             {/* Contact Details */}
             <div className="space-y-4">
                <h4 className="font-mono text-sm text-neutral-500 uppercase tracking-widest">Contact Details</h4>
                <a href="mailto:rpraolini@icloud.com" className="flex items-center gap-3 text-lg hover:text-orange-500 transition-colors group">
                  <Mail size={20} className="text-orange-500 group-hover:scale-110 transition-transform"/> 
                  rpraolini@icloud.com
                </a>
             ...
             <div className="space-y-4">
                <h4 className="font-mono text-sm text-neutral-500 uppercase tracking-widest">Social Presence</h4>
                <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-lg hover:text-blue-400 transition-colors group">
                  <Linkedin size={20} className="text-blue-500 group-hover:scale-110 transition-transform"/> 
                  LinkedIn
                </a>
                <a href="https://github.com" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-lg hover:text-white transition-colors group">
             ...
             {/* Final CTA */}
             <div className="space-y-4">
                <h4 className="font-mono text-sm text-neutral-500 uppercase tracking-widest">Action</h4>
                <a href="/cv.pdf" className="flex items-center gap-2 text-lg hover:text-orange-500 transition-colors">
                  <Download size={18}/> Download CV
                </a>
                <a href="#" className="flex items-center gap-2 text-lg hover:text-green-500 transition-colors">
                  <Calendar size={18}/> Schedule a Chat
                </a>
             </div>

           </div>

           <div className="mt-24 pt-8 border-t border-neutral-900 flex justify-between text-xs font-mono text-neutral-600">
             <span>© 2025 Riccardo Praolini.</span>
